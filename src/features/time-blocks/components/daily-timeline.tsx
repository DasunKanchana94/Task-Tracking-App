...
import { useCreateTimeBlock, useTimeBlocks, useUpdateTimeBlock } from "@/features/time-blocks/lib/use-time-blocks";
  ...
  return (
    <div className="relative flex">
      ...
      >
        ...
        {(blocks ?? []).map((block) => (
          <TimelineBlockItem key={block.id} block={block} dayStart={dayStart} onChange={handleBlockChange} />
        ))}
